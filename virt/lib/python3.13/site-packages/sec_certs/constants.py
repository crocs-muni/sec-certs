...
NIAP_BASE_URL = "https://www.niap-ccevs.org"
NIAP_PP_API_URL = NIAP_BASE_URL + "/api/protection-profile/public_pps_all/"
NIAP_PP_DETAIL_URL = NIAP_BASE_URL + "/protectionprofiles/{}"
NIAP_PP_FILE_API_URL = NIAP_BASE_URL + "/api/file/get_public_files_by_type_and_type_id/"
NIAP_PP_FILE_DOWNLOAD_URL = NIAP_BASE_URL + "/api/file/get_public_file/"

# Mapping from NIAP Technology Type to CC Categories
NIAP_TECH_TYPE_TO_CC_CATEGORY: dict[str, str] = {
