        ...
        def get_vulnerable_cpes_from_nist_dict(dct: Dict) -> List[CPE]:
                ...
                if "cpe_match" in node:
                    ...
                    for x in lst:
                        if x["vulnerable"]:
                            ...
                            if (
                                "versionStartIncluding" in x
                                and x["versionStartIncluding"]
                            ):
                                version_start = (
                                    "including",
                                ...
                                "versionStartExcluding" in x
                                and x["versionStartExcluding"]
                            ):
                                version_start = (
                                    "excluding",
                                    x["versionStartExcluding"],
                                )
                            else:
                                version_start = None
                            ...
                            if "versionEndIncluding" in x and x["versionEndIncluding"]:
                                ...
                                "versionEndExcluding" in x and x["versionEndExcluding"]
                            ):
                            ...
                            cpe_uris.append(
                                CPE(
                                    cpe_uri,
                                    start_version=version_start,
                                    end_version=version_end,
                                )
                            )
            ...
            return list(
                itertools.chain.from_iterable(
                    [
                        get_vulnerable_cpes_from_node(x)
                        for x in dct["configurations"]["nodes"]
                    ]
                )
            )
