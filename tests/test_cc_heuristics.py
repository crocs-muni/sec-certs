...
class TestCPEandCVEMatching(TestCase):
    ...
    # TODO: Continue here
    # On each test, create tmp dir and copy data there
    # Then create dataset inside that tmp dir and do something with it, according to the required tests


    def setUp(self) -> None:
        self.test_data_dir = Path(__file__).parent / 'data' / 'test_cpe_cve'
        #self.test_data_dir = path(tests).joinpath('')) / 'data' / 'test_cpe_cve'
