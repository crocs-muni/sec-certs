    ...
    def generate_modal_filter_ui(filter_specs, current_ready):
        ...
        for i in range(0, len(filter_specs), 2):
            ...
            for spec in filter_specs[i : i + 2]:
                ...
                field_id = pattern_builder.pattern(ComponentID.MODAL_FILTER, spec["id"], index_key="field")
            ...
            children=[
                ...
                html.Div(
                    ...
                    children=[
                        dbc.Button(
                            "Select All",
                            id=pattern_builder.pattern(ComponentID.SELECT_ALL_FILTER, spec["id"], index_key="field"),
                            color="link",
                            size="sm",
                        ...
                        dbc.Button(
                            "Clear",
                            id=pattern_builder.pattern(ComponentID.CLEAR_FILTER, spec["id"], index_key="field"),
                            color="link",
                            size="sm",
                            className="p-0 text-decoration-none",
                        ),
...
def _create_clear_button(collection_name: CollectionName, field_id: str) -> dbc.Button:
    ...
    return dbc.Button(
        ...
        id=pattern_builder.pattern(ComponentID.CLEAR_FILTER, field_id, index_key="field"),
        color="secondary",
        outline=True,
        size="sm",
        className="px-2",
