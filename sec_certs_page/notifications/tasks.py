...
@dramatiq.actor(max_retries=3, actor_name="send_notification_confirmation_email", queue_name="notifications")
...
@dramatiq.actor(max_retries=3, actor_name="send_notification_unsubscription_email", queue_name="notifications")
