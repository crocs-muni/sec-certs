...
cve_schema = (
    ...
    .add_text_field("cve_tokenized", stored=False)
    ...
    .add_text_field("cvss_version", stored=True, tokenizer_name="raw", index_option="basic")
    .add_text_field("cwe", stored=True)
...
cpe_schema = (
    ...
    # combined searchable text powering the main query box (vendor + product + title + uri)
